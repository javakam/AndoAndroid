...
import com.improve.modules.provider.ProviderSwipeFragment1;
import com.improve.modules.rxjava.RxJavaSwipeFragment1;
...
import com.improve.modules.thread.ThreadNavSwipeFragment;
...
import com.improve.modules.widgets.AutoCompleteTextViewSwipeFragment;
import com.improve.modules.widgets.ButtonSwipeFragment;
import com.improve.modules.widgets.CatFlexboxLayoutSwipeFragment;
import com.improve.modules.widgets.FlexboxLayoutSwipeFragment;
import com.improve.modules.widgets.TextViewSwipeFragment;
...
//        L.i("i:" + i);
    ...
    public static List<QDItemDescription> getHomeGridDescriptions() {
        ...
        list.add(new QDItemDescription(ProviderSwipeFragment1.class, UIRouter.FRAG_PROVIDER1, getImage()));
        ...
        list.add(new QDItemDescription(ThreadNavSwipeFragment.class, UIRouter.FRAG_THREAD_NAV, getImage()));
...
//        list.add(new QDItemDescription(WanSwipeFragment.class, UIRouter.FRAG_WAN_ANDROID, getImage()));
        ...
        list.add(new QDItemDescription(RxJavaSwipeFragment1.class, UIRouter.FRAG_RXJAVA2, getImage()));
    ...
    public static List<QDItemDescription> getComponentsDescriptions() {
        ...
        list.add(new QDItemDescription(TextViewSwipeFragment.class, UIRouter.FRAG_WIDGET_TEXTVIEW, getImage()));
        list.add(new QDItemDescription(AutoCompleteTextViewSwipeFragment.class, UIRouter.FRAG_WIDGET_EDITTEXT, getImage()));
        list.add(new QDItemDescription(ButtonSwipeFragment.class, UIRouter.FRAG_WIDGET_BUTTON, getImage()));
        list.add(new QDItemDescription(FlexboxLayoutSwipeFragment.class, UIRouter.FRAG_WIDGET_FLEXBOX, getImage()));
        list.add(new QDItemDescription(CatFlexboxLayoutSwipeFragment.class, UIRouter.FRAG_WIDGET_FLEXBOX_CAT, getImage()));
