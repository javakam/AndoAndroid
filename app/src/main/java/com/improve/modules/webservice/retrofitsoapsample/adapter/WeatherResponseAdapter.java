package com.improve.modules.webservice.retrofitsoapsample.adapter;
...
public class WeatherResponseAdapter extends RecyclerView.Adapter<WeatherResponseAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from( parent.getContext() ).inflate(R.layout.item_weather_result, null);
