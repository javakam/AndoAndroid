...
public class MyTest extends AndroidTestCase {
    ...
    public void calltest() {
        ...
        Uri uri = Uri
                .parse("content://com.sq.support.provider.StudentProvider/student");
    ...
    public void delete() {
        ContentResolver contentResolver = getContext().getContentResolver();
        // 删除多行：content://com.sq.support.provider.StudentProvider/student
        Uri uri = Uri
                .parse("content://com.sq.support.provider.StudentProvider/student/1");
    ...
    public void update() {
        ContentResolver contentResolver = getContext().getContentResolver();
        Uri uri = Uri
                .parse("content://com.sq.support.provider.StudentProvider/student/2");
        ContentValues values = new ContentValues();
        values.put("name", "李四");
